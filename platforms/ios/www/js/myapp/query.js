...
function initMap() {
    ...
    if(name){
        document.getElementById("parkHolder").innerHTML = "<p class='footerButton' class='park' id='park1' onclick='unpark()' >UNPARK</p>";
        ...
        $( ".park" ).click(function() {
            ...
            if(true  ){
                circle.setOptions({
                    ...
                    clicked = 0;
                    if (confirm("Did you get a ticket?") && reportedAlready == false){
                        alert("Thanks! \n +2 Points");
                        reportedAlready = true;
                        updatePoints();
                                        ...
                                        $( ".report" ).click(function() {
                                            ...
                                            for(var street = 0; street < streets.length; street++){
                                                ...
                                                MySql.Execute(
                                                    ...
                                                    "parkingNINJA", 
                                                    "Testing", 
                                                    "update Streets set "+riskHour+" = "+convertedSub+" where Name = '"+streets[street]+"';", 
                                                    function (data) {
